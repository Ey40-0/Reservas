...
CREATE TABLE `class` (
  ...
  `id_fam` int NOT NULL,
  PRIMARY KEY (`id_cla`),
  KEY `fk_class_product_family1_idx` (`id_fam`),
  CONSTRAINT `fk_class_product_family1` FOREIGN KEY (`id_fam`) REFERENCES `product_family` (`id_fam`)
...
INSERT INTO `class` VALUES (1,'Zumba',1);
