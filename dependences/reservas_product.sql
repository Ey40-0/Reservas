...
CREATE TABLE `product` (
  ...
  `id_fam` int NOT NULL,
  PRIMARY KEY (`id_pro`),
  KEY `fk_product_product_family_idx` (`id_fam`),
  CONSTRAINT `fk_product_product_family` FOREIGN KEY (`id_fam`) REFERENCES `product_family` (`id_fam`)
...
INSERT INTO `product` VALUES (1,'Gold anual',1);
